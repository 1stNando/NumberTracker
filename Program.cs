...
namespace NumberTracker
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //We wrapped all of the code below to improve
            if (File.Exists("numbers.csv"))
            {
                ...
                //Create our List<int> but from *READING* the data from the file!!
                //replace our empty list of numbers with the populated version!
